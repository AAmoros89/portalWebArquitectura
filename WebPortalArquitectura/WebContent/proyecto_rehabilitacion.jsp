...
<body>
	...
	<h1>Proyecto de Rehabilitación</h1>
	<div class="contenedor-formulario contenedor">
		...
		<form class="formulario" name="form1" method="get"
			...
			<div class="input">
				<label for="superficie_r">Superficie a reformar</label> <input
					placeholder="Ingresa la superficie a reformar(m2)" type="text"
					name="superficie_r" id="superficie_r">
			</div>
