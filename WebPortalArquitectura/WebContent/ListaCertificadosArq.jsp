...
<link rel="stylesheet"
	href="resources/css/estilo_lista_certificadosArq.css" />
</head>
...
<body>
	...
	<form class="formulario" method="post" action="menuArq.jsp">
		...
		<table>
			...
			<c:forEach var="temCertificado" items="${LISTACERTIFICADOS}">
				...
				<c:url var="linkTempEditar" value="ControladorCertificados">
					<!-- se le pasa como valor la clase de controladorClientes -->
					<c:param name="instruccion" value="cargarCertificadoArq"></c:param>
					<!-- se le pasa como parametro la instruccion -->
					<c:param name="id" value="${temCertificado.id}"></c:param>
					<c:param name="idUsuario" value="${temCertificado.idUsuario}"></c:param>
					<c:param name="fechaSolicitud"
					...
					<c:param name="idArquitecto" value="${temCertificado.idArquitecto}"></c:param>
					<c:param name="tipo" value="${temCertificado.tipo}"></c:param>
					<c:param name="fechaVisita" value="${temCertificado.fechaVisita}"></c:param>
				</c:url>

				<c:url var="linkTempPresup" value="ControladorCertificados">
					<!-- se le pasa como valor la clase de controladorClientes -->
					<c:param name="instruccion" value="presupuestarCertificadoArq"></c:param>
					<!-- se le pasa como parametro la instruccion -->
					<c:param name="id" value="${temCertificado.id}"></c:param>
					<c:param name="idUsuario" value="${temCertificado.idUsuario}"></c:param>
					<c:param name="fechaSolicitud"
					...
					<c:param name="tipo" value="${temCertificado.tipo}"></c:param>
					<c:param name="fechaVisita" value="${temCertificado.fechaVisita}"></c:param>
					<c:param name="presupuesto" value="${temCertificado.presupuesto}"></c:param>
					<c:param name="fechaEmision" value="${temCertificado.fechaEmision}"></c:param>
					<c:param name="categoria" value="${temCertificado.categoria}"></c:param>
					<c:param name="estado" value="${temCertificado.estado}"></c:param>

				</c:url>

				<c:url var="linkTempEmision" value="ControladorCertificados">
					<!-- se le pasa como valor la clase de controladorClientes -->
					<c:param name="instruccion" value="emitirCertificadoArq"></c:param>
					<!-- se le pasa como parametro la instruccion -->
					<c:param name="id" value="${temCertificado.id}"></c:param>
					<c:param name="idUsuario" value="${temCertificado.idUsuario}"></c:param>
					<c:param name="fechaSolicitud"
				...
				<tr>
					...
					<td>${temCertificado.categoria}</td>
					<td>${temCertificado.estado}</td>
					<td><a href="${linkTempEditar}">Seleccionar Fecha Visita</a></td>
					<td><a href="${linkTempPresup}">Presupuestar</a></td>
					<td><a href="${linkTempEmision}">Emitir certificado</a></td>
