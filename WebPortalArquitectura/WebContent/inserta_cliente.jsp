...
<body>
 ...
 <%
 		...
 		PreparedStatement pst = conn.prepareStatement("select max (p.id) +1 from cliente7 p");		
 ...
 <h1>Regístrate</h1>
	<div class= "contenedor-formulario contenedor">
		...
		<form class="formulario" name="form1" method="get" action="ControladorClientes">
		<input type="hidden" name="instruccion" value="insertarBBDDCliente">
			...
			<div class = "input">
				...
				<input  type ="text" name="id" id="id" value="<%= cliente.idIncrementable() %>"/>
			</div>
