...
<meta http-equiv="Content-Type" content="text/html; charset=ISO-8859-1">
	...
	<link rel="stylesheet" href="resources/css/estilo_actualizar_certificado.css"/>
</head>
<body>
	...
	<div class= "contenedor-formulario contenedor">
		...
		<form class="formulario" name="form1" method="get" action="ControladorCertificados">
			<input type="hidden" name="instruccion" value="actualizarPresupCertificadoArq">
			...
			<div class = "input">
				<label for="presupuesto">Presupuesto Certificado</label>
				<input  type="text" name="presupuesto" id="presupuesto" value="${CertificadoActualizar.presupuesto}"/> <!-- con esto se crear el cuadro de texto -->	
			</div>
			
			<input type="hidden" name="estado" id="estado" value="${CertificadoActualizar.estado}"/>
						
			<div class = "input">
				<input type="submit" value="Enviar Presupuesto"> <!-- se crea un boton, submit es para que envie la info del formulario, insertar es el texto -->			
			</div>		
