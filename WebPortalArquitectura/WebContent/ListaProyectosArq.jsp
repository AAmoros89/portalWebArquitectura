...
<link rel="stylesheet"
	href="resources/css/estilo_lista_proyectosArq.css" />
</head>
		...
		<table>
			...
			<c:forEach var="temProyecto" items="${LISTAPROYECTOS}">
				<c:url var="linkTempEditar" value="ControladorProyectos">
					...
					<c:param name="instruccion" value="cargarProyectoArq"></c:param>
					...
					<c:param name="duracionPrevista"
						value="${temProyecto.duracionPrevista}"></c:param>
				...
				<tr>
					...
					<td><a href="${linkTempEditar}">Presupuestar</a></td>
				</tr>
			</c:forEach>
		</table>
	</div>
